        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 dark:border-white/10 overflow-hidden">
            <div className="p-6 border-b border-gray-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-2">
                    <button className="px-4 py-2 border border-gray-200 dark:border-white/10 rounded-lg text-sm font-medium text-japfa-gray dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 flex items-center gap-2 transition-all">
                        ...
                        {[
                            ...
                            <tr key={idx} className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                                ...
                                <td className="py-4 px-6 text-right">
                                    <button className="px-3 py-1.5 bg-japfa-orange/10 dark:bg-japfa-orange/20 text-japfa-orange text-xs font-bold rounded hover:bg-japfa-orange hover:text-white transition-all">Details</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
